        ...
        ScrollView {
            VStack(spacing: 24) {
                Text("Article 1")
                    .font(.largeTitle)
                    .bold()
                // Ad unit placeholder in the top
                RoundedRectangle(cornerRadius: 12)
                    .fill(Color.gray.opacity(0.2))
                    .frame(width: 320, height: 320)
                    .frame(maxWidth: .infinity, alignment: .center)
                ...
                Text("Even more filler text. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.")
                    .padding()
                        // Second ad unit placeholder
                RoundedRectangle(cornerRadius: 12)
                    .fill(Color.gray.opacity(0.2))
                    .frame(width: 320, height: 160)
                    .frame(maxWidth: .infinity, alignment: .center)
                    .overlay(Text("Ad Unit 2").foregroundColor(.gray))
                    .padding(.vertical, 8)
                Spacer()
                }
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                // Filler text before ad
                    ...
                    """)
                    .padding()
                // Ad unit placeholder in the middle
                RoundedRectangle(cornerRadius: 12)
                    .fill(Color.gray.opacity(0.2))
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                // Filler text before first ad
                    ...
                    """)
                    .padding()
                // First ad unit placeholder
                RoundedRectangle(cornerRadius: 12)
                    .fill(Color.gray.opacity(0.2))
                    .frame(width: 320, height: 160)
                    .frame(maxWidth: .infinity, alignment: .center)
                    .overlay(Text("Ad Unit 1").foregroundColor(.gray))
                    .padding(.vertical, 8)
                // More filler text
                    Text("""
                    Continuation of Article 2. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
